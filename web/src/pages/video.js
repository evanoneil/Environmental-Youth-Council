...
const VideoPage = props => {
    ...
    <Layout>
      ...
      <Container>
        <section class="cf w-100  pa5">
          ...
          <h2 class="tc dark-blue f2 tc">Houston Teens Care about Clean Air <br />Video Contest</h2>
          <h3 class="lh-copy dark-blue fw1 f4 ttu tc">The Contest </h3>
          <p class="lh-copy fw3 f3">
            Houston area high school students - We want to hear <span class="i">your</span> stories! Create a short video (1 to
            2 minutes) that shows us what <span class="i">you</span> want to say about dirty air,
            climate change, health and the environment in Houston.          </p>
          <ul>
          ...
          <p class="lh-copy fw3 f3">
          Be creative! Be yourself! We want to see anything and everything: animations, music videos, comedies, interviews, documentarie …
          </p>
          <p class="lh-copy fw3 f3">
            ...
            <div class="w-100 flex flex-wrap green tc">
              <div class="w-33-ns w-100 flex tc pa3">
                  <span class="tc center">
                    <p>
                      <b>First Place</b> <br /><br /> <span class="f3">$2,500 Visa gift card</span>
                    </p>
                  </span>
              </div>
              ...
              <div class="w-33-ns w-100 flex tc pa3">
                <span class="tc center">
                  <p>
                    <b>Second Place</b> <br /><br /> <span class="f3">$1,500 Visa gift card </span>     </p>
                </span>
              </div>
              ...
              <div class="w-33-ns w-100 flex tc pa3">
                <span class=" tc center">
                  <p>
                    <b>Third Place</b> <br /><br /> <span class="f3">$500 Visa Gift Card</span>      </p>
                </span>
              </div>
              <span class="tc center">
                    <p>
                      <b> <span class="f3 fw1">YouTube People’s Choice Award
</span></b>
                    </p>
                  </span>
            </div>
  ...
  <span class="i">Contact your campus context coordinator for submission instructions. </span>
          </p>

  <h3 class="lh-copy dark-blue fw1 tc f4 ttu mt5">How to Participate </h3>
  <p class="lh-copy fw3 tc f3">
  Only students from the following approved high schools may participate:<br />
Galena Park High School <br />Pasadena Memorial High School <br />Raul Yzaguirre Schools for Success (RYSS) <br />Kashmere High School

<br /><br />
Want to create a video? Pick up a Participant Packet from the contest coordinator at your school. 
<br /><br />

Campus Coordinators:<br />
Pasadena Memorial HS – Mrs. Ashley Poloha<br />
Galena Park HS – Mr. Andree Torres<br />
RYSS – Mrs. Rebecca Engquist<br />
Kashmere HS - TBD
          ...
          <ul>
            <li class="lh-copy fw3 f3 mb3">
            Videos may be created by individuals or groups of up to 4 students. Only one submission per person or team. 
            </li>
            <li class="lh-copy fw3 f3 mb3">
            ...
            <li class="lh-copy fw3 f3 mb3"> 
            Videos must be original and unpublished works that have never been previously submitted in another contest or film festival.             
            </li>
            <li class="lh-copy fw3 f3 mb3"> 
          ...
          <ul>
            ...
            Provides relevant, factual information about air pollution/climate change AND impacts on health from credible sources (must be cited at end of video)
            </li>
            <li class="lh-copy fw3 f3 mb3">
...
<br /><b>“Illustrated: Particulate Matter's Health Effects” </b> <br />by Kevin Juarez, Pasadena Memorial High School
          ...
          <h3 class="tc dark-blue f3 tc">TEACHERS AND ADMINISTRATORS CLICK THE BUTTON BELOW <br />
To receive information about how your school can participate!</h3>
