...
const Header = ({ onHideNav, onShowNav, showNav, siteTitle, message, nodes }) => (
  <div class="z1">
      ...
      <div className={styles.bluebk}>
        <nav class="dt w-100 bg-white pl5 pr5 pt3 pb3 center galaxy">
          ...
          <div class="dtc-ns db  v-mid tr pa3">
            ...
            <Link class="f6 fw4 hover-blue no-underline black-70 green  pv2 ph3" to="./video">
              Video Contest
            </Link>
            <Link
              class="f6-ns f7 fw4 hover-blue no-underline black-70  ml2 pv2 ph3 ba"
              to="./contact"
            >
              Contact Us
            </Link>
        ...
        <article class="vh-50 pa4 mt4 dt w-100">
          <div class="tc v-top tc black ph3 ph4-l">
            <center>
              <h1 class="mw7 f2-m f2-l f3 fw6 tc white mb3">
