      ...
      <div class="flex flex-wrap justify-center">
        ...
        <article class="br2 dark-gray ma3   w-100 w-40-m w-30-l  bg-green  ">
          ...
          <div class="pa2 ph3-ns pb3-ns">
            <div class="dt w-100 mt1">
              <div class="dtc">
                <h1 class="f5 f4-ns mv3 dark-blue">
                  Science-Based Curricula & Leadership Training
                </h1>
              </div>
            </div>
            <p class="f6 lh-copy measure mt2 white">
              Hands-on lessons about air pollution, climate change, environmental justice, health
              and local government are paired with leadership and civics training to introduce
              students to important issues and develop problem-solving skills to address them.
            </p>
          </div>
        </article>
        ...
        <article class="br2    dark-gray  ma3  w-100 w-40-m w-30-l  bg-green   ">
          ...
          <div class="pa2 ph3-ns pb3-ns">
            ...
            <p class="f6 lh-copy measure mt2 white">
              Experts from local government, nonprofit organizations and established research
              institutions share their firsthand knowledge to show students what the work for clean
              air and for a healthy, sustainable city looks like. Guest speakers have included staff
              from the City of Houston, Harris County Health Department, UT School of Public Health
              and Rice University.
            </p>
          </div>
        </article>
        ...
        <article class="br2    dark-gray ma3   w-100 w-40-m w-30-l  bg-green    ">
          ...
          <div class="pa2 ph3-ns pb3-ns">
            ...
            <p class="f6 lh-copy measure mt2   white">
              Student field trips to local museums, government meetings, industry hubs and community
              organizations put students directly in touch with the resources for change in their
              region.
            </p>
          </div>
        </article>
        ...
        <article class="br2    dark-gray ma3   w-100 w-40-m w-30-l  bg-green   ">
          ...
          <div class="pa2 ph3-ns pb3-ns">
            ...
            <p class="f6 lh-copy measure mt2   white">
              Students participate in local community events to improve health and address
              environmental challenges. Events may include CPR training, neighborhood cleanups and
              voter registration drives, and are geared at teaching students the necessary skills to
              organize in their communities to make a difference.
            </p>
          </div>
        </article>
        ...
        <article class="br2    dark-gray ma3   w-100 w-40-m w-30-l  bg-green    ">
          ...
          <div class="pa2 ph3-ns pb3-ns">
            ...
            <p class="f6 lh-copy measure mt2   white">
              At the end of the school year, students organize community town hall meetings. Public
              discussions of the issues that arise from their experiences help students learn to
              communicate with their friends, family members and community to raise awareness and
              create consensus.
            </p>
          </div>
        </article>
        ...
        <article class="br2    dark-gray ma3   w-100 w-40-m w-30-l  bg-green   ">
          ...
          <div class="pa2 ph3-ns pb3-ns">
            ...
            <p class="f6 lh-copy measure mt2   white">
              Top students in the program have the opportunity to travel to Washington, D.C. Tours
              inside the offices of elected officials, environmental organizations and agencies and
              museums show students firsthand how environmental policies are made.{" "}
            </p>
          </div>
        </article>
      </div> */}
